board name=combination_board gravity=20.0 friction1=0.020 friction2=0.020
 ball name=Ball x=0.5 y=0.5 xVelocity=5.5 yVelocity=2.5
#
  ...
  fire trigger=Square0 action=FlipL1
    fire trigger=Square1 action=FlipL1
    fire trigger=Square2 action=FlipL1
    fire trigger=Square3 action=FlipL1
    fire trigger=Square4 action=FlipL1
    fire trigger=Square5 action=FlipL1
    fire trigger=Square6 action=FlipL1
    fire trigger=Square7 action=FlipL1
    
   fire trigger=Square12 action=FlipR1
   fire trigger=Square13 action=FlipR1
   fire trigger=Square14 action=FlipR1
   fire trigger=Square15 action=FlipR1
   fire trigger=Square16 action=FlipR1
   fire trigger=Square17 action=FlipR1
   fire trigger=Square18 action=FlipR1
    fire trigger=Square19 action=FlipR1
    
    fire trigger=Tri1 action=FlipL2
    fire trigger=Tri2 action=FlipR2
